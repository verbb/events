...
class Session extends Element implements NestedElementInterface
{
    ...
    public function getFieldLayout(): ?FieldLayout
    {
        ...
        try {
            ...
            return $this->getOwner()->getType()->getSessionFieldLayout();
    ...
    {
        return UrlHelper::actionUrl('events/ics', ['sessionId' => $this->id]);
    }
    ...
    public function getPurchasedSeatsCount(): int
    {
        ...
        if ($this->_purchasedSeatsCount === null) {
            $this->_purchasedSeatsCount = Events::$plugin->getPurchasedTickets()->getPurchasedSeatsCountForSession($this->id);
        }
