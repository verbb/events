...
Craft.Events.LicenseForm = Craft.BaseElementIndex.extend({
    licenseKey: null,
    ...
    loadLicenseInfo: function(action) {
        Craft.postActionRequest('events/license/getLicenseInfo', $.proxy(function(response, textStatus) {
    ...
    handleUnregisterLicenseFormSubmit: function(ev) {
        ...
        Craft.postActionRequest('events/license/unregister', $.proxy(function(response, textStatus) {
    ...
    handleUpdateLicenseFormSubmit: function(ev) {
        ...
        Craft.postActionRequest('events/license/updateLicenseKey', data, $.proxy(function(response, textStatus) {
    ...
    handleTransferLicenseFormSubmit: function(ev) {
        ...
        Craft.postActionRequest('events/license/transfer', $.proxy(function(response, textStatus) {
