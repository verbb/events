...
Craft.Events.EventEdit = Garnish.Base.extend({
    ...
    init: function(id) {
        ...
        this.$startDate = this.$container.find('#startDate-date');
        this.$startTime = this.$container.find('#startDate-time');
        this.$endDate = this.$container.find('#endDate-date');
        this.$endTime = this.$container.find('#endDate-time');
